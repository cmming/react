...
export default class CustomKeyPage extends Component {
    ...
    onClick(data) {
        ...
        // alert(JSON.stringify(this.changeValues))
    }
    ...
    renderView() {
        ...
        return views;
        // return <Text style={{height:300,width:300}}>111{JSON.stringify(this.state.dataArray)}</Text>
    }
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                {navigationBar}
                <ScrollView>
                    {/*<Text>111244{JSON.stringify(this.state.dataArray)}</Text>*/}
                    {this.renderView()}
                </ScrollView>
            </View>
        )

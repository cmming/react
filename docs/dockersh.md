...
9. 创建两个Haproxy容器
   ...
   ```shell
   #创建第1个Haproxy负载均衡服务器
   docker run -it -d -p 4001:8888 -p 4002:3306 -v /home/soft/haproxy:/usr/local/etc/haproxy -v /home/soft/keepalived:/etc/keepalived --name h1 --privileged --net=net1 --ip 172.18.0.7 haproxy
   #进入h1容器，启动Haproxy
   docker exec -it h1 bash
   haproxy -f /usr/local/etc/haproxy/haproxy.cfg
   #创建第2个Haproxy负载均衡服务器
   docker run -it -d -p 4003:8888 -p 4004:3306 -v /home/soft/haproxy:/usr/local/etc/haproxy -v /home/soft/keepalived:/etc/keepalived --name h2 --privileged --net=net1 --ip 172.18.0.8 haproxy
   #进入h2容器，启动Haproxy
...
3. 创建6节点Redis容器
   ...
   ```shell
   docker run -it -d -v /home:/home --name r1 --privileged -p 5001:6379 --net=net2 --ip 172.19.0.2 redis bash
   docker run -it -d -v /home:/home --name r2 --privileged -p 5002:6379 --net=net2 --ip 172.19.0.3 redis bash
   docker run -it -d -v /home:/home --name r3 --privileged -p 5003:6379 --net=net2 --ip 172.19.0.4 redis bash
   docker run -it -d -v /home:/home --name r4 --privileged -p 5004:6379 --net=net2 --ip 172.19.0.5 redis bash
   docker run -it -d -v /home:/home --name r5 --privileged -p 5005:6379 --net=net2 --ip 172.19.0.6 redis bash
   docker run -it -d -v /home:/home --name r6 --privileged -p 5006:6379 --net=net2 --ip 172.19.0.7 redis bash
   ```
...
5. 创建Nginx容器，配置负载均衡
   ...
   ```shell
   docker run -it -d --name n1 -v /home/n1/nginx.conf:/etc/nginx/nginx.conf -v /home/nk1:/etc/keepalived --net=host --privileged nginx
   ...
   ```shell
   docker run -it -d --name n2 -v /home/n2/nginx.conf:/etc/nginx/nginx.conf -v /home/nk1:/etc/keepalived --net=host --privileged nginx
   ```
...
6. 在Nginx容器安装Keepalived
   ...
   virtual_server 192.168.50.90 80 {
       delay_loop 3
       lb_algo rr
       lb_kind NAT
       persistence_timeout 50
       protocol TCP
       real_server 192.168.50.90 6101 {
           weight 1
       }
   }
   ```
...
4. 配置负载均衡
   ...
   ```shell
   #启动ff1节点
   docker run -it -d --name ff1 -v /home/ff1/nginx.conf:/etc/nginx/nginx.conf -v /home/ff1:/etc/keepalived --net=host --privileged nginx
   ```
   ...
   ```shell
   #启动ff2节点
   docker run -it -d --name ff2 -v /home/ff2/nginx.conf:/etc/nginx/nginx.conf -v /home/ff1:/etc/keepalived --net=host --privileged nginx
   ```
